    ...
    IEnumerator ShowLoadDialogCoroutine()
{
    ...
    public Transform content; // Assign the Content GameObject of the Scroll View
    ...
    public void LoadImageFromBase64(string base64String, RawImage rawImage)
    {
        ...
        rawImage.SetNativeSize(); // This sets the RawImage to the size of the texture
    }
